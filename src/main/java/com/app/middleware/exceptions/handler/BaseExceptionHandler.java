...
import com.app.middleware.exceptions.response.ErrorResponse;
...
public class BaseExceptionHandler {
    ...
    public ExceptionResponse aladdinExceptionHandler(HttpServletRequest req, GenericException e) {
        ...
        log.accessLoggerError("Response | URL:"+ req.getRequestURL() +" | Request failed with message : "
                + e.getErrorMessage() + " and Error Status: " + e.getErrorCode() + " -- Error Details -- "
                + " | Error Code : " + e.getAppErrorType().getErrorCode()
                + " | Error Name : " + e.getAppErrorType().toString()
                + " | Error Message : " + e.getAppErrorType().getMessage()
                + " | Front-End Message : " + e.getAppErrorType().getErrorMessage());

        return ExceptionResponse.builder()
                .status(e.getAppErrorType().getErrorCode())
                .error_name(e.getAppErrorType() == null ? null : e.getAppErrorType().toString())
                .message(e.getAppErrorType() == null ? null : e.getAppErrorType().getErrorMessage())
                .build();
    }
