...
public class AuthConstants {
    ...
    public static final String RESCHEDULED_REQUESTED_SUCCESSFULLY = " reschedule requested successfully";
    public static final String RESCHEDULED_REJECTED_SUCCESSFULLY = " reschedule request turned down";
    public static final String RESCHEDULED_ACCEPTED_SUCCESSFULLY = " rescheduled successfully";
