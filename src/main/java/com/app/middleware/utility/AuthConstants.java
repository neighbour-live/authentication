...
public class AuthConstants {
    ...
    public static final String VERIFICATION_EMAIL_SENT = " Email verification code is sent, please check your inbox at ";
    ...
    public static final String VERIFICATION_OTP_SENT = "OTP is sent ";
