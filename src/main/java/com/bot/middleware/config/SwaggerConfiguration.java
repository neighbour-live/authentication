...
public class SwaggerConfiguration extends WebMvcConfigurerAdapter {
    ...
    public static final ApiInfo DEFAULT_API_INFO = new ApiInfo(
            ...
            "This is swagger documentation of BOT API Resources.",
            "0.0.1",
            "Companies Private property.",
            DEFAULT_CONTACT,
            "Apache 2.0",
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bot.middleware.resources.controller"))
