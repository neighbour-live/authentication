...
import com.bot.middleware.persistence.repository.FirebaseLogRepository;
import com.bot.middleware.persistence.repository.UserNotificationRepository;
...
import com.bot.middleware.persistence.type.RequestStatus;
import com.bot.middleware.resources.services.EmailService;
import com.bot.middleware.resources.services.FCMService;
    ...
    public void sendCardVerificationTemplateReminder() {
        ...
        users.forEach(user -> {
            ...
            try {
                emailService.sendEmailFromExternalApi(EmailNotificationDto.builder()
                        .to(user.getEmail())
                        .template(Constants.EmailTemplate.WALLET_VERIFICATION_TEMPLATE.value())
                        .build());
            } catch (IOException e) {
                e.printStackTrace();
                logger.error(e.getMessage());
    ...
    public void sendSterlingVerificationTemplateReminder() {
        ...
        users.forEach(user -> {
            ...
            try {
                emailService.sendEmailFromExternalApi(EmailNotificationDto.builder()
                        .to(user.getEmail())
                        .template(Constants.EmailTemplate.STERLING_VERIFICATION_TEMPLATE.value())
                        .build());
            } catch (IOException e) {
                e.printStackTrace();
                logger.error(e.getMessage());
    ...
    public void sendPhoneVerificationTemplateReminder() {
        ...
        users.forEach(user -> {
            ...
            try {
                emailService.sendEmailFromExternalApi(EmailNotificationDto.builder()
                        .to(user.getEmail())
                        .template(Constants.EmailTemplate.PHONE_VERIFICATION_TEMPLATE.value())
                        .build());
            } catch (IOException e) {
                e.printStackTrace();
                logger.error(e.getMessage());
