...
import com.bot.middleware.persistence.response.PushNotificationResponse;
...
//
//    @PostMapping("/topic")
//    public String sendPnsToTopic(@RequestBody UserNotificationRequest userNotificationRequestDto) {
//        return notificationService.sendPnsToTopic(userNotificationRequestDto);
//    }
//
//    //Old Demo
//    @PostMapping("/topic")
...
//        placeHolders.put("Sender_Address", "House No. 18, Block No 11, Sector 11-F, New Karachi");
//
