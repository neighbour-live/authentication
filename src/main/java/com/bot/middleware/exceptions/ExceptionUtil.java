package com.bot.middleware.exceptions;

import com.bot.middleware.exceptions.constants.ExceptionConstants;
import com.bot.middleware.exceptions.constants.ForeignKeyExceptionConstants;
import com.bot.middleware.exceptions.constants.NotNullExceptionConstants;
import com.bot.middleware.exceptions.constants.UniqueKeyExceptionConstants;
...
//                throw new ValidationException(new FieldError("gender", "gender", "Gender must be M, F or O"));
    ...
    private static void handleForeignKeyException (String constraintName, BaseEntity baseEntity) throws ResourceNotFoundException {
        switch (constraintName) {
            ...
            case ForeignKeyExceptionConstants.FK_user_id_user_payment_cards: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.USER_NOT_FOUND_WITH_PUBLIC_ID_IN_USER_PAYMENT_CARD;
                if (baseEntity instanceof UserPaymentCard)
                    resourceNotFoundErrorType.setValue(((UserPaymentCard) baseEntity).getPublicId() != null ? ((UserPaymentCard) baseEntity).getUser().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_user_id_user_skills: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.USER_NOT_FOUND_WITH_PUBLIC_ID_IN_USER_SKILL;
                if (baseEntity instanceof UserSkill)
                    resourceNotFoundErrorType.setValue(((UserSkill) baseEntity).getPublicId() != null ? ((UserSkill) baseEntity).getUser().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }
            ...
            case ForeignKeyExceptionConstants.FK_skill_id_user_skills: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.SKILL_NOT_FOUND_WITH_PUBLIC_ID_IN_USER_SKILL;
                if (baseEntity instanceof UserSkill)
                    resourceNotFoundErrorType.setValue(((UserSkill) baseEntity).getPublicId() != null ? ((UserSkill) baseEntity).getUser().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_blocked_by_tasks: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.BLOCKED_BY_USER_NOT_FOUND_WITH_PUBLIC_ID_IN_TASK;
                if (baseEntity instanceof Task)
                    resourceNotFoundErrorType.setValue(((Task) baseEntity).getPublicId() != null ? ((Task) baseEntity).getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_task_public_id_reviews: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.TASK_NOT_FOUND_WITH_PUBLIC_ID_IN_REVIEW;
                if (baseEntity instanceof Task)
                    resourceNotFoundErrorType.setValue(((Task) baseEntity).getPublicId() != null ? ((Task) baseEntity).getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_supplier_public_id_tasks: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.SUPPLIER_USER_NOT_FOUND_WITH_PUBLIC_ID_IN_TASK;
                if (baseEntity instanceof Task)
                    resourceNotFoundErrorType.setValue(((Task) baseEntity).getPublicId() != null ? ((Task) baseEntity).getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_poster_public_id_reviews: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.POSTER_USER_NOT_FOUND_WITH_PUBLIC_ID_IN_REVIEW;
                if (baseEntity instanceof Review)
                    resourceNotFoundErrorType.setValue(((Review) baseEntity).getPublicId() != null ? ((Review) baseEntity).getTask().getPoster().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_tasker_public_id_reviews: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.TASKER_NOT_FOUND_WITH_PUBLIC_ID_IN_REVIEW;
                if (baseEntity instanceof Review)
                    resourceNotFoundErrorType.setValue(((Review) baseEntity).getPublicId() != null ? ((Review) baseEntity).getTask().getTasker().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_buyer_public_id_tasks: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.TASKER_USER_NOT_FOUND_WITH_PUBLIC_ID_IN_TASK;
                if (baseEntity instanceof Task)
                    resourceNotFoundErrorType.setValue(((Task) baseEntity).getPublicId() != null ? ((Task) baseEntity).getPoster().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_user_public_id_user_certifications: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.USER_NOT_FOUND_WITH_ID_IN_USER_CERTIFICATIONS;
                if (baseEntity instanceof UserCertification)
                    resourceNotFoundErrorType.setValue(((UserCertification) baseEntity).getPublicId() != null ? ((UserCertification) baseEntity).getUser().getId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }
            //here
            case ForeignKeyExceptionConstants.FK_user_address_tasks: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.USER_ADDRESS_NOT_FOUND_WITH_PUBLIC_ID_IN_TASK;
                if (baseEntity instanceof Task)
                    resourceNotFoundErrorType.setValue(((Task) baseEntity).getPublicId() != null ? ((UserAddress) baseEntity).getUser().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }
...
//            }
            ...
            case ForeignKeyExceptionConstants.FK_user_id_user_bank_account: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.USER_NOT_FOUND_WITH_PUBLIC_ID_IN_USER_BANK_ACCOUNT;
                if (baseEntity instanceof UserBankAccount)
                    resourceNotFoundErrorType.setValue(((UserBankAccount) baseEntity).getPublicId() != null ? ((UserBankAccount) baseEntity).getUser().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_user_public_id_user_wallet: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.USER_NOT_FOUND_WITH_PUBLIC_ID_IN_USER_WALLET;
                if (baseEntity instanceof UserWallet)
                    resourceNotFoundErrorType.setValue(((UserWallet) baseEntity).getPublicId() != null ? ((UserWallet) baseEntity).getUser().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_user_public_id_user_transactions: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.USER_NOT_FOUND_WITH_PUBLIC_ID_IN_USER_TRANSACTIONS;
                if (baseEntity instanceof UserTransactions)
                    resourceNotFoundErrorType.setValue(((UserTransactions) baseEntity).getPublicId() != null ? ((UserTransactions) baseEntity).getUser().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_user_id_user_certifications: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.USER_NOT_FOUND_WITH_PUBLIC_ID_IN_USER_CERTIFICATIONS;
                if (baseEntity instanceof UserCertification)
                    resourceNotFoundErrorType.setValue(((UserCertification) baseEntity).getPublicId() != null ? ((UserCertification) baseEntity).getUser().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_user_id_support_user: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.USER_NOT_FOUND_WITH_PUBLIC_ID_IN_SUPPORT_USER;
                if (baseEntity instanceof SupportUser)
                    resourceNotFoundErrorType.setValue(((SupportUser) baseEntity).getPublicId() != null ? ((SupportUser) baseEntity).getUser().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_reporter_user_id_report_user: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.REPORTER_USER_NOT_FOUND_WITH_PUBLIC_ID_IN_REPORT_USER;
                if (baseEntity instanceof ReportUser)
                    resourceNotFoundErrorType.setValue(((ReportUser) baseEntity).getPublicId() != null ? ((ReportUser) baseEntity).getReporter().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_reported_user_id_report_user: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.REPORTED_USER_NOT_FOUND_WITH_PUBLIC_ID_IN_REPORT_USER;
                if (baseEntity instanceof ReportUser)
                    resourceNotFoundErrorType.setValue(((ReportUser) baseEntity).getPublicId() != null ? ((ReportUser) baseEntity).getReported().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_task_id_user_bids: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.TASK_NOT_FOUND_WITH_PUBLIC_ID_IN_USER_BIDS;
                if (baseEntity instanceof UserBid)
                    resourceNotFoundErrorType.setValue(((UserBid) baseEntity).getPublicId() != null ? ((UserBid) baseEntity).getTask().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_user_id_user_bids: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.USER_NOT_FOUND_WITH_PUBLIC_ID_IN_USER_BIDS;
                if (baseEntity instanceof UserBid)
                    resourceNotFoundErrorType.setValue(((UserBid) baseEntity).getPublicId() != null ? ((UserBid) baseEntity).getUser().getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }

            case ForeignKeyExceptionConstants.FK_task_category_tasks: {
                ResourceNotFoundErrorType resourceNotFoundErrorType = ResourceNotFoundErrorType.TASK_CATEGORY_NOT_FOUND_WITH_PUBLIC_ID;
                if (baseEntity instanceof TaskCategories)
                    resourceNotFoundErrorType.setValue(((TaskCategories) baseEntity).getPublicId() != null ? ((TaskCategories) baseEntity).getPublicId().toString() : null);
                throw new ResourceNotFoundException(resourceNotFoundErrorType);
            }
    ...
    public static PageableResponseEntity<Object> handlePaginatedException(Exception e) throws Exception {
        ...
        if(e instanceof com.stripe.exception.ApiException){
            throw new com.stripe.exception.ApiException(((com.stripe.exception.ApiException) e).getStripeError().getMessage(), ((com.stripe.exception.ApiException) e).getRequestId(), ((com.stripe.exception.ApiException) e).getCode(), ((com.stripe.exception.ApiException) e).getStatusCode(), e.getCause());
        }

        if(e instanceof ApiException) {
            boolean APIExceptionError = true;
            String APIExceptionMessage = ((ApiException) e).getMessage();
            String APIExceptionCode = String.valueOf(((ApiException) e).getStatusCode());
            throw new Exception(APIExceptionCode + ": " + APIExceptionMessage);
        }
